  ...
  <footer>
    <span class="footer-items">
      ...
      <span v-if="$route.path.includes('/blog/') && $route.path.length > 6">
        /
        <a target="_blank" :href="editURL"> Edit</a>
      </span>
    </span>
  </footer>
</template>
...
export default {
  ...
  created() {
    const mdFile = this.$route.params.slug
    this.editURL = `https://github.com/bswank/swank.dev/edit/master/content/posts/${mdFile}.md`
  }
}
</script>
